...
export default function Admission() {
  ...
  return (
    <div className="w-[50%] m-auto space-y-10 divide-y mt-32 divide-gray-900/10">
      <div>
        ...
        <form className="bg-white shadow-sm ring-1 py-3 ring-gray-900/5 sm:rounded-xl md:col-span-2">
          <div className="flex justify-evenly">
            ...
            <SelectDropdown label={"Admission type"} list={people} />
            <SelectDropdown label={"Classes"} list={people2} />
          </div>
