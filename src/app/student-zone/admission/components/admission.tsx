...
export default function Admission() {
  ...
  const people3 = [{ name: "MCAT" }, { name: "BCAT" }, { name: "T ECAT" }];
  return (
    <div className="w-[60%] m-auto space-y-10 divide-y mt-32 divide-gray-900/10">
      <div className="grid grid-cols-1 gap-x-8 gap-y-8 md:grid-cols-3">
        ...
        <form className="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
          ...
          <div className="flex justify-evenly">
            <Dropdown heading={"Admission for"} list={admissionfor} />
            <Dropdown heading={"Admission type"} list={people} />
            <Dropdown heading={"Classes"} list={people2} />
          </div>
