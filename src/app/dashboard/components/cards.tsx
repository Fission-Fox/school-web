...
export default function Cards() {
  return (
    <div className="w-[24%] h-[345px] rounded-3xl bg-white m-2">
      <Image className="py-6 ml-8" src={fingerprint} alt="" />
      <p className="text-[24px] font-bold px-8 text-[#2B3674] ">
      ...
      <p className="text-[#A3AED0] text-[14px] py-2 px-8">
        Discover our cards benefits, with one tap.
      </p>

      <div className="w-[80%] bg-[#4318FF] h-[44px] rounded-2xl text-center py-2 text-white font-bold ml-8 mt-5">
        {" "}
        <button>Cards</button>
      </div>
    </div>
