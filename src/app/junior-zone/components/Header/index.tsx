        ...
        <div className="ml-1 sm:ml-10 md:ml-20 lg:ml-0  flex items-center bg-[#ffffff]  fixed z-50 w-full top-0 !justify-between lg:!justify-evenly gap-5">
          ...
          <div className="flex mr-1 sm:mr-10 md:mr-20 lg:gap-4  items-center">
            ...
            <Link href={"/student-zone/admission"}>
              <div className="cursor-pointer text-[14px] xl:text-[16px] !hidden lg:!flex  bg-[#E8063C] hover:bg-[#4D0D58] border-[#E8063C] border-[3px] px-2 xl:px-6 py-2 xl:py-3 font-semibold text-[#ffffff] rounded-full">
                Apply Today
              </div>
            </Link>
          </div>
