  ...
  return (
    <div className=" bg-[#f8f7f7] w-full mt-6 pt-20 pb-40">
      ...
      {/* <div className="flex flex-row  justify-center gap-10">
        <div className="bg-[#fff] w-[17%]">
          ...
          <div className="px-10">
            ...
            <div className="flex flex-row gap-2">
              <div className="text-[#00306e] mt-3">< PersonPinCircleIcon /></div>
        ...
        <div className="bg-[#fff] w-[17%] h-96 ">
          <div className="text-[#D2093C] text-[50px] font-sans font-bold mt-2 px-10">
            14{" "}
          </div>
          <div className="px-10">
      ...
      >
        ...
        {/* <SwiperSlide className="mb-16">
          ...
          <div className="flex flex-wrap justify-center items-center m-auto flex-col lg:flex-row  gap-10">
            <div className="bg-[#fff] xl:w-[17%] !py-4 xl:!py-10">
              <div className="text-[#D2093C] text-[50px] font-sans font-bold mt-2 px-10">
                10{" "}
              </div>
              <div className="px-10">
            ...
            <div className="bg-[#fff] w-[14] xl:w-[17%] !py-4 xl:!py-10">
              <div className="text-[#D2093C] text-[50px] font-sans font-bold mt-2 px-10">
                26{" "}
              </div>
              <div className="px-10">
